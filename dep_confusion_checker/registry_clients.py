...
# ⚡ Bolt: Use a global requests.Session to reuse the underlying TCP connection
# across multiple requests to the same registry, reducing latency from repeated handshakes.
