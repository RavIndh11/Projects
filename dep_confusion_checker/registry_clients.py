...
# ⚡ Bolt: Use a global requests.Session to reuse underlying TCP connections
# across multiple registry queries, significantly reducing latency from repeated handshakes.
